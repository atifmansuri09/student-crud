...
<head>
    ...
    <style>
        nav.navbar {
            ...
            border-top: 1px solid rgba(201, 168, 92, 0.45);
            position: relative;
            /* overflow: hidden; */
        }
...
<body>
    ...
    <div class="container-fluid Management-Section py-5 mt-2" id="OurManagement">
        <section class="Management row" id="Management">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
                <!-- MANAGEMENT SLIDER 1 -->
                <div id="carouselExampleCaptionManagement1" class="carousel slide" data-bs-ride="carousel"
                    data-bs-pause="false">
            ...
            <div class="Management-img col-lg-6 col-md-12 col-sm-12">
                ...
                <div id="carouselExampleCaptionManagement2" class="carousel slide" data-bs-ride="carousel"
                    data-bs-pause="false">
                    <div class="carousel-indicators">
                        <button type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="0"
                            class="active" aria-current="true" aria-label="Slide 1"></button>
                    ...
                    <button class="carousel-control-prev" type="button"
                        data-bs-target="#carouselExampleCaptionManagement2" data-bs-slide="prev">
                        <span class="Carousel-Btn carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleCaptions"
    ...
    <section class="contact-section py-5">
        <div class="container">
            ...
            <div class="Header text-center mb-5">
                <h1>Contact Us</h1>
                <p>Have a question? Send us an owl and we'll get back to you.</p>
            </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-md-5">
                    ...
                    <h3>Get In Touch</h3>
                    <p>
                        Whether you have a question about Hogwarts or need
                        assistance, feel free to reach out to us.
                    </p>

                    <div class="mt-4">
                        <h5><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor"
                                class="bi bi-geo-alt-fill mb-2" viewBox="0 0 16 16">
                                <path
                    ...
                    <div class="mt-4">
                        <h5><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor"
                                class="bi bi-telephone-plus-fill mb-2" viewBox="0 0 16 16">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 column-4 pt-5">
                        ...
                        <p class="footer-text text-start fs-5 mb-4">
                        ...
                        <p class="footer-text text-start ms-1 fs-5 mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor"
                                class="bi bi-envelope-fill" viewBox="0 0 16 16">
                                <path
                                    d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414zM0 4.697v7.104l5.803-3.558zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586zm3.436-.586L16 11.801V4.697z" />
                            </svg> info@hogwarts.edu
                        </p>
                        <p class="footer-text text-start ms-1 fs-5 mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor"
                                class="bi bi-telephone-plus-fill mb-2" viewBox="0 0 16 16">
